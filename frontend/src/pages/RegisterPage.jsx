            ...
            <Card className="auth-card">
                <Row className="g-0">
                     ...
                     <Col md={6} className="auth-branding-section d-none d-md-flex">
                         <div>
                              <h2 style={{ color: '#FFD700' }}>Buat akun baru</h2>
                            <p style={{ color: '#FFD700' }}>Selamat datang. Silahkan lakukan registrasi akun anda. Jika sudah melakukan registrasi silahkan login mennggunakan Username dan Password yang anda buat sebelumnya.</p>
                         </div>
                     </Col>
